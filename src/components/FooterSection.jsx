...
import { Mail, Send, Star, Loader2, CheckCircle, XCircle } from "lucide-react";
      ...
      <AnimatePresence>
        {snackbar.show && (
          <motion.div
            ...
            exit={{ y: -60, opacity: 0 }}
            className={`fixed top-5 left-1/2 -translate-x-1/2 px-5 py-3 rounded-md shadow-lg text-sm font-medium z-50 ${
