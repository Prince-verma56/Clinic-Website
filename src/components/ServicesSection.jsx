    ...
    >
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        ...
        <motion.div
          ...
          className="image-box relative flex-shrink-0 w-full max-w-md lg:max-w-xl order-2 lg:order-1"
        >
          <div
        ...
        <div className="flex-1 max-w-2xl text-center lg:text-left order-1 lg:order-2 space-y-6">
          <motion.h2
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="text-4xl md:text-5xl font-extrabold font-ubuntu leading-tight text-[#3b2f2f] dark:text-zinc-100"
          >
            Your path to{" "}
